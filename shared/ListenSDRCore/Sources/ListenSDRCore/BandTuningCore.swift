...
public struct BandTuningContext: Sendable {
  ...
  public init(
    ...
    self.bandTags = bandTags
  }
}

public struct BandTuningProfile: Equatable, Sendable {
  public let id: String
  public let stepOptionsHz: [Int]
  public let defaultStepHz: Int

  public init(id: String, stepOptionsHz: [Int], defaultStepHz: Int) {
    self.id = id
...
public enum BandTuningProfiles {
  public static func resolve(for context: BandTuningContext) -> BandTuningProfile {
