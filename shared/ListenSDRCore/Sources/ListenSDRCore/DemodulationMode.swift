...
public struct ReceiverBandpass: Codable, Equatable, Hashable, Sendable {
  public let lowCut: Int
  public let highCut: Int

  public init(lowCut: Int, highCut: Int) {
    self.lowCut = lowCut
    self.highCut = highCut
  }
}

public enum DemodulationMode: String, Codable, CaseIterable, Identifiable, Sendable {
  case am
  case amn
  case amw
  case fm
  ...
  public static let openWebRXSupportedModes: [DemodulationMode] = [
    .am, .fm, .nfm, .usb, .lsb, .cw
  ]

  public static let kiwiSupportedModes: [DemodulationMode] = [
    .am, .amn, .amw,
    .nfm, .nnfm,
    .usb, .usn,
    .lsb, .lsn,
  ...
  public var isFineTuningMode: Bool {
    switch self {
  ...
  public func normalized(for backend: SDRBackend) -> DemodulationMode {
    switch backend {
    case .fmDxWebserver:
  ...
  public var kiwiProtocolMode: String {
  ...
  public var kiwiDefaultBandpass: ReceiverBandpass {
    switch normalized(for: .kiwiSDR) {
    case .am:
  ...
  public var openWebRXProtocolMode: String {
  ...
  public var openWebRXDefaultBandpass: ReceiverBandpass {
    switch normalized(for: .openWebRX) {
    case .am, .amn, .amw, .iq, .drm, .sam, .sau, .sal, .sas, .qam:
      return ReceiverBandpass(lowCut: -4_900, highCut: 4_900)
    case .fm:
  ...
  public static func fromKiwi(_ rawValue: String?) -> DemodulationMode? {
  ...
  public static func fromOpenWebRX(_ rawValue: String?) -> DemodulationMode? {
    guard let rawValue else { return nil }
    switch rawValue.lowercased() {
    case "am":
      return .am
